            ...
            content: [
              {
                ...
                text: [
                  ...
                  '- Definir needsReview=true SEMPRE que houver RASURA OU baixa confiança OU dígito ambíguo.',

                  'Regra para placar eletrônico: (FOTO de uma Tela de placar eletrônico)',
                  ...
                  '- Retorne scores como array, todas as pontuações da respectiva letra devem ser incluídas.',
                  '- Exemplo: Se D tem 3 jogos, retorne scores=[{game:1,value:157},{game:2,value:200},{game:3,value:180}]',
                  ...
                  'SE ATENTE AO PARA TODAS AS REQUISIÇÕES: Formato obrigatório de resposta:',
                  '{',
                  '  "players": [',
                  '    {',
                  '      "letter": "A",',
                  ...
                  '- Caso nao consiga ler algum valor, lembrar de marcar o needReview=true e colocar o motivo no campo reason.',
                ].join('\n'),
              },
              {
                type: 'image_url',
